...
# Download the files
Because **HaCasa Next** can’t be installed through the UI, we will need to manually download and upload some files to your Home Assistant configuration.

But don’t worry, we’ll guide you through it 😄

> ℹ️ The installation steps are identical to the original [HaCasa](https://github.com/damianeickhoff/HaCasa).  
> The only difference is that you’ll be downloading the **HaCasa Next** release files instead.  
...
1. Go to the [latest release of HaCasa Next](https://github.com/N0edL/HaCasa-Next/releases).
2. Download the latest `HaCasa-Next.zip` file.
...
Once the files are in place, proceed to the [configuration guide](https://n0edl.github.io/HaCasa-Next/docs/installation/configuration.html) to set up your dashboard.